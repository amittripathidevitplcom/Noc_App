...
export class AhApplyNocApplicationListComponent {
  ...
  constructor(private animalDocumentScrutinyService: AnimalDocumentScrutinyService, private sSOLoginService: SSOLoginService,
  ...
  async Dealing_AssistantApplicationPreview_OnClick(DepartmentID: number, CollegeID: number, ApplyNOCID: number, ApplicationNo: string) {
    if (DepartmentID = 2) {
