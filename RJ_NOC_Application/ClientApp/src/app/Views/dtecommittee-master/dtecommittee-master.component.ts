...
@Component({
  selector: 'app-dtecommittee-master',
  templateUrl: './dtecommittee-master.component.html',
  styleUrls: ['./dtecommittee-master.component.css']
})
export class DTECommitteeMasterComponent implements OnInit {
