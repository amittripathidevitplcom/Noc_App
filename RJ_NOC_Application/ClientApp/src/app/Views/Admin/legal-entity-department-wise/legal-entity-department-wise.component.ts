...
@Component({
  selector: 'app-legal-entity-department-wise',
  templateUrl: './legal-entity-department-wise.component.html',
  styleUrls: ['./legal-entity-department-wise.component.css']
})
export class LegalEntityDepartmentWiseComponent implements OnInit {
