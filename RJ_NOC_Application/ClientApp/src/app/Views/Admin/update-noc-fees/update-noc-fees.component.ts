...
import { ParameterFeeMaster } from '../../../Models/ApplyNOCApplicationDataModel';
...
export class UpdateNocFeesComponent {
  ...
  constructor(private applyNOCApplicationService: ApplyNOCApplicationService, private modalService: NgbModal, private loaderService: LoaderService, private toastr: ToastrService,
