...
@Component({
  selector: 'app-college-management-society-revert',
  templateUrl: './college-management-society-revert.component.html',
  styleUrls: ['./college-management-society-revert.component.css']
})
export class CollegeManagementSocietyRevertComponent implements OnInit {
