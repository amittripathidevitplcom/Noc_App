...
@Component({
  selector: 'app-application-forward-gthree',
  templateUrl: './application-forward-gthree.component.html',
  styleUrls: ['./application-forward-gthree.component.css']
})



export class ApplicationForwardGThreeComponent implements OnInit {
