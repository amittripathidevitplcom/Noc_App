...
@Component({
  selector: 'app-generate-order-mgone',
  templateUrl: './generate-order-mgone.component.html',
  styleUrls: ['./generate-order-mgone.component.css']
})
export class GenerateOrderMGOneComponent {
  ...
  async GenerateOrder() {
    ...
    try {
      ...
      this.loaderService.requestStarted();
      await this.mgoneNOCService.GenerateOrderForInspectionReport(this.SelectedDepartmentID, this.SelectedCollageID, this.SelectedApplyNOCID, this.sSOLoginDataModel.UserID, this.Filedoc)
        .then((data: any) => {
