...
@Component({
  selector: 'app-deputy-secretary-list-mgone',
  templateUrl: './deputy-secretary-list-mgone.component.html',
  styleUrls: ['./deputy-secretary-list-mgone.component.css']
})
export class DeputySecretaryListMGOneComponent implements OnInit {
