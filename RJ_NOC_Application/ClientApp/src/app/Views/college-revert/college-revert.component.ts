...
@Component({
  selector: 'app-college-revert',
  templateUrl: './college-revert.component.html',
  styleUrls: ['./college-revert.component.css']
})
export class CollegeRevertComponent implements OnInit {
  //Add FormBuilder
