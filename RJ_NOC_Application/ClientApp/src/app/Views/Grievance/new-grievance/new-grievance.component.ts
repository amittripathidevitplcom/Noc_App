...
//  requestGrievance = new GrievanceDataModel();
...
//  public GrievanceMasterData: any;
...
//    private formBuilder: FormBuilder, private commonMasterService: CommonMasterService, private router: ActivatedRoute, private routers: Router, private _fb: FormBuilder, private clipboard: Clipboard, private fileUploadService: FileUploadService, private modalService: NgbModal,) { }
...
//          this.SuccessMessage = data['SuccessMessage'];
//          this.ErrorMessage = data['ErrorMessage'];
//          this.GrievanceMasterData = data['Data'][0];
//        }, error => console.error(error));
//    }
//    catch (Ex) {
//      console.log(Ex);
...
//    this.loaderService.requestStarted();
//    if (this.GrievanceMasterData.length > 0) {
//      try {
...
//        /* save to file */
//        XLSX.writeFile(wb, "GrievanceMaster.xlsx");
//      }
//      catch (Ex) {
//        console.log(Ex);
//      }
...
//    }
//  }
//  async ReopenGrievancePopUP(content: any, GrievanceID: number, DepartmentID: number, CollegeID: number, DepartmentName: string, CollegeName: string) {
//    debugger;
//    this.ResetControlPopUp();
...
//    //  return
//    //}
//    if (this.requestGrievance.GrievanceRemark == '' || this.requestGrievance.GrievanceRemark == null) {
...
//    this.requestGrievance.SSOID = this.sSOLoginDataModel.SSOID;
//    this.requestGrievance.GrievanceID = this.SelectedGrievanceID;
//    this.requestGrievance.Action = "ReOpen";

//    try {
//      await this.grievanceService.SaveData(this.requestGrievance)
//        .then((data: any) => {
//          this.State = data['State'];
//          this.SuccessMessage = data['SuccessMessage'];
//          this.ErrorMessage = data['ErrorMessage'];
...
//    }
//  }
//  async ResetControlPopUp() {
//    this.isSubmitted = false;
//    this.requestGrievance.GrievanceID = 0;
//    this.requestGrievance.SSOID = '';
//    this.requestGrievance.DepartmentID = 0;
//    this.requestGrievance.CollegeID = 0;
//    this.requestGrievance.GrievanceRemark = '';
//    this.requestGrievance.AttachmentFile = '';
//    this.requestGrievance.AttachmentFile_Dis_FileName = '';
//    this.requestGrievance.AttachmentFilePath = '';
...
//          this.ErrorMessage = data['ErrorMessage'];
//          if (this.State == 0) {
//            this.requestGrievance.AttachmentFile = data['Data'][0]["FileName"];
//            this.requestGrievance.AttachmentFile_Dis_FileName = data['Data'][0]["Dis_FileName"];
//            this.requestGrievance.AttachmentFilePath = data['Data'][0]["FilePath"];
...
//  async DeleteImages(file: string) {
//    try {
