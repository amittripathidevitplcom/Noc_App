...
@Component({
  selector: 'app-preview-scurteny-comittee',
  templateUrl: './preview-scurteny-comittee.component.html',
  styleUrls: ['./preview-scurteny-comittee.component.css']
})
export class PreviewScurtenyComitteeComponent implements OnInit { 
