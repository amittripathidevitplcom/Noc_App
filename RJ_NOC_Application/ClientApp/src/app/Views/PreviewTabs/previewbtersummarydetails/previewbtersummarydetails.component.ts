...
@Component({
  selector: 'app-previewbtersummarydetails',
  templateUrl: './previewbtersummarydetails.component.html',
  styleUrls: ['./previewbtersummarydetails.component.css']
})



export class PreviewbtersummarydetailsComponent implements OnInit {
