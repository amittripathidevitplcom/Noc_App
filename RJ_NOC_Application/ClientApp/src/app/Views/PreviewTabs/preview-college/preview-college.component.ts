...
@Component({
  selector: 'app-preview-college',
  templateUrl: './preview-college.component.html',
  styleUrls: ['./preview-college.component.css']
})
export class PreviewCollegeComponent implements OnInit {
