...
@Component({
  ...
  templateUrl: './apply-nocjoint-sec-preview.component.html',
  styleUrls: ['./apply-nocjoint-sec-preview.component.css']
})
export class ApplyNOCJointSecPreviewComponent implements OnInit {
