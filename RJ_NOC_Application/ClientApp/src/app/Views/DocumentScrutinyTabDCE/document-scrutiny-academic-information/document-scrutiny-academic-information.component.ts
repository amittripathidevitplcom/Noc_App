...
export class DocumentScrutinyAcademicInformationComponentDce implements OnInit {
  ...
  constructor(private modalService: NgbModal, private dceDocumentScrutinyService: DCEDocumentScrutinyService,private academicInformationDetailsService: AcademicInformationDetailsService, private loaderService: LoaderService, private formBuilder: FormBuilder,
