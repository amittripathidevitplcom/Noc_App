...
@Component({
  selector: 'app-document-scrutiny-veterinary-hospital-dce',
  templateUrl: './document-scrutiny-veterinary-hospital.component.html',
  styleUrls: ['./document-scrutiny-veterinary-hospital.component.css']
})
export class DocumentScrutinyVeterinaryHospitalComponentDce implements OnInit {
