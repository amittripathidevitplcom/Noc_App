...
@Component({
  selector: 'app-document-scrutiny-room-details-dce',
  templateUrl: './document-scrutiny-room-details.component.html',
  styleUrls: ['./document-scrutiny-room-details.component.css']
})
export class DocumentScrutinyRoomDetailsComponentDce implements OnInit {
  ...
  constructor(private modalService: NgbModal,private commonMasterService: CommonMasterService, private router: ActivatedRoute, private loaderService: LoaderService, private dcedocumentScrutinyService: DCEDocumentScrutinyService,
