...
@Component({
  selector: 'app-mgone-class-room-details',
  templateUrl: './mgone-class-room-details.component.html',
  styleUrls: ['./mgone-class-room-details.component.css']
})
export class MGOneClassRoomDetailsComponent implements OnInit {
