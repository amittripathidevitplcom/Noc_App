...
@Component({
  selector: 'app-mg1-document-scrutiny-hospital-detail',
  templateUrl: './mg1-document-scrutiny-hospital-detail.component.html',
  styleUrls: ['./mg1-document-scrutiny-hospital-detail.component.css']
})
export class MG1DocumentScrutinyHospitalDetailComponent implements OnInit {
      ...
      await this.mg1DocumentScrutinyService.DocumentScrutiny_HospitalDetail(this.SelectedCollageID, this.sSOLoginDataModel.RoleID, this.SelectedApplyNOCID)
        .then(async (data: any) => {
          ...
          if (data['Data'].length > 0) {
            ...
            console.log(this.HospitalParentNotDataModelList);
