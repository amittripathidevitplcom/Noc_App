...
@Component({
  selector: 'app-mg1-document-scrutiny-land-detail',
  templateUrl: './mg1-document-scrutiny-land-detail.component.html',
  styleUrls: ['./mg1-document-scrutiny-land-detail.component.css']
})
export class MG1DocumentScrutinyLandDetailComponent implements OnInit {
  ...
  constructor(
    private mg1documentscrutiny: DocumentScrutinyMGOneComponent, private landDetailsService: LandDetailsService, private mg1documentScrutinyService: MGOneDocumentScrutinyService, private commonMasterService: CommonMasterService, private router: ActivatedRoute, private loaderService: LoaderService,
