...
@Component({
  selector: 'app-mg1-document-scrutiny-required-document',
  templateUrl: './mg1-document-scrutiny-required-document.component.html',
  styleUrls: ['./mg1-document-scrutiny-required-document.component.css']
})
export class MG1DocumentScrutinyRequiredDocumentComponent implements OnInit {
  ...
  constructor(private mg1documentscrutiny: DocumentScrutinyMGOneComponent, private collegeDocumentService: CollegeDocumentService, private commonMasterService: CommonMasterService,
