...
@Component({
  selector: 'app-document-scrutiny-check-list-mgone',
  templateUrl: './document-scrutiny-check-list-mgone.component.html',
  styleUrls: ['./document-scrutiny-check-list-mgone.component.css']
})
export class DocumentScrutinyCheckListMGOneComponent implements OnInit {
