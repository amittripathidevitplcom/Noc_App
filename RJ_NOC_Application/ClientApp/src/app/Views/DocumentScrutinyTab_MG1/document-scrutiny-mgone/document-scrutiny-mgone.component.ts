...
@Component({
  selector: 'app-document-scrutiny-mgone',
  templateUrl: './document-scrutiny-mgone.component.html',
  styleUrls: ['./document-scrutiny-mgone.component.css']
})
export class DocumentScrutinyMGOneComponent implements OnInit {
