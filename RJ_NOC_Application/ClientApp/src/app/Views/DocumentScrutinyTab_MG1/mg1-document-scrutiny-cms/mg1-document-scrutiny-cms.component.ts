...
@Component({
  selector: 'app-mg1-document-scrutiny-cms',
  templateUrl: './mg1-document-scrutiny-cms.component.html',
  styleUrls: ['./mg1-document-scrutiny-cms.component.css']
})
export class MG1DocumentScrutinyCMSComponent implements OnInit {
  ...
  constructor(private mg1documentscrutiny: DocumentScrutinyMGOneComponent, private socityService: SocityService, private toastr: ToastrService, private loaderService: LoaderService, private formBuilder: FormBuilder,
  ...
  //  this.mg1documentScrutinyService.ViewTarilCommon(ID, ActionType);
  //}
