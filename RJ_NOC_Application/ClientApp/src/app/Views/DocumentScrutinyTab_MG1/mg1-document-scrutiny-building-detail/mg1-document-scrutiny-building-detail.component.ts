...
@Component({
  selector: 'app-mg1-document-scrutiny-building-detail',
  templateUrl: './mg1-document-scrutiny-building-detail.component.html',
  styleUrls: ['./mg1-document-scrutiny-building-detail.component.css']
})
export class MG1DocumentScrutinyBuildingDetailComponent implements OnInit {
  buildingdetails: any = {};
  ...
  constructor(
    private mg1documentscrutiny: DocumentScrutinyMGOneComponent, private buildingDetailsMasterService: BuildingDetailsMasterService, private commonMasterService: CommonMasterService, private mg1DocumentScrutinyService: MGOneDocumentScrutinyService,
    ...
    try {
      ...
      await this.mg1DocumentScrutinyService.DocumentScrutiny_BuildingDetails(this.SelectedCollageID, this.sSOLoginDataModel.RoleID, this.SelectedApplyNOCID)
        .then((data: any) => {
          ...
          console.log(this.lstBuildingDetails);
