...
@Component({
  selector: 'app-mg1-document-scrutiny-legal-entity',
  templateUrl: './mg1-document-scrutiny-legal-entity.component.html',
  styleUrls: ['./mg1-document-scrutiny-legal-entity.component.css']
})
export class MG1DocumentScrutinyLegalEntityComponent implements OnInit {

  constructor(private mg1documentscrutiny: DocumentScrutinyMGOneComponent,private mg1documentScrutinyService: MGOneDocumentScrutinyService, private applyNOCApplicationService: ApplyNOCApplicationService, private legalEntityListService: LegalEntityService, private toastr: ToastrService, private loaderService: LoaderService, private formBuilder: FormBuilder, private commonMasterService: CommonMasterService, private router: ActivatedRoute, private routers: Router, private collegeService: CollegeService, private sSOLoginService: SSOLoginService) { }
