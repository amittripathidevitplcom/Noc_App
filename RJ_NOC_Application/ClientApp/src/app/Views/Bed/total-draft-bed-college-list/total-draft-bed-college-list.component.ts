...
@Injectable()
@Component({
  selector: 'app-total-draft-bed-college-list',
  templateUrl: './total-draft-bed-college-list.component.html',
  styleUrls: ['./total-draft-bed-college-list.component.css']
})
export class TotalDraftBedCollegeListComponent {
  ...
  async GetTotalDraftentryCollege() {
    try {
      this.loaderService.requestStarted();
      this.request.DepartmentID = this.sSOLoginDataModel.DepartmentID;
      this.request.Type = 'FinalDraftSubmit';
