...
@Component({
  selector: 'app-exam-results-regional-center',
  templateUrl: './exam-results-regional-center.component.html',
  styleUrls: ['./exam-results-regional-center.component.css']
})
export class ExamResultsRegionalCenterComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.request.EntryType = "Results Regional Center";
