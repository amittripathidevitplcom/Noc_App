...
@Component({
  selector: 'app-distance-mode',
  templateUrl: './distance-mode.component.html',
  styleUrls: ['./distance-mode.component.css']
})
export class DistanceModeComponent implements OnInit {
