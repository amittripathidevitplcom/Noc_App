...
@Component({
  selector: 'app-distance-other-minority-breakup',
  templateUrl: './distance-other-minority-breakup.component.html',
  styleUrls: ['./distance-other-minority-breakup.component.css']
})
export class DistanceOtherMinorityBreakupComponent {
  ...
  async ngOnInit() {
    ...
    this.request.EntryType = "Distance Other Minority Breakup";
