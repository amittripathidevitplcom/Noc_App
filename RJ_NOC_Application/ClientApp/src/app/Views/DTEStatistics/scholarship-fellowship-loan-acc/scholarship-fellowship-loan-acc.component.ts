...
import { ScholarshipFellowshipLoanAccDataModel, ScholarshipFellowshipLoanAccDataModel_ProgrammesDetails, ScholarshipFellowshipLoanAccDataModel_StudentDetails } from '../../../Models/DTEStatistics/ScholarshipFellowshipLoanAccDataModel';
...
export class ScholarshipFellowshipLoanAccComponent implements OnInit {
  ...
  request_ScholarshipFellowshipLoanAccDetails = new ScholarshipFellowshipLoanAccDataModel_ProgrammesDetails();
  ...
  async btnAdd_Click(row: ScholarshipFellowshipLoanAccDataModel_ProgrammesDetails, idx: number) {
    if (row != undefined) {
