...
@Component({
  selector: 'app-student-enrollment-regular-mode',
  templateUrl: './student-enrollment-regular-mode.component.html',
  styleUrls: ['./student-enrollment-regular-mode.component.css']
})
export class StudentEnrollmentRegularModeComponent implements OnInit {
