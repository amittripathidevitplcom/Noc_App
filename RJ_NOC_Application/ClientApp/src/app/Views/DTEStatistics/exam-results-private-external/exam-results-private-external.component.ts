...
@Component({
  selector: 'app-exam-results-private-external',
  templateUrl: './exam-results-private-external.component.html',
  styleUrls: ['./exam-results-private-external.component.css']
})
export class ExamResultsPrivateExternalComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.request.EntryType = "Results Private External";
