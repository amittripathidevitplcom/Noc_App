...
@Component({
  selector: 'app-private-external-mode',
  templateUrl: './private-external-mode.component.html',
  styleUrls: ['./private-external-mode.component.css']
})
export class PrivateExternalModeComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.request.EntryType = "Private External Mode";
