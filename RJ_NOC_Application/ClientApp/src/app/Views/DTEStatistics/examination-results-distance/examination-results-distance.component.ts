...
@Component({
  selector: 'app-examination-results-distance',
  templateUrl: './examination-results-distance.component.html',
  styleUrls: ['./examination-results-distance.component.css']
})
export class ExaminationResultsDistanceComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.request.EntryType = "Results Distance";
