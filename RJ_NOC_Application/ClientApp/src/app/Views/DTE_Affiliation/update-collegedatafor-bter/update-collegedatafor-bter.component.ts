...
@Injectable()
  ...
  @Component({
    selector: 'app-update-collegedatafor-bter',
    templateUrl: './update-collegedatafor-bter.component.html',
    styleUrls: ['./update-collegedatafor-bter.component.css']
  })
export class UpdateCollegedataforBTERComponent implements OnInit {
  //Add FormBuilder
    ...
    try {
      ...
      await this.commonMasterService.GetCommonMasterList_DepartmentAndTypeWise(departmentId, "AffiliationCategory")
        .then((data: any) => {
          ...
          if (this.SelectedDepartmentID == 12 && this.CollegeStatusName != '') {
            this.CollegeStatusList = this.CollegeStatusList.filter((element: any) => { return element.Name.includes(this.CollegeStatusName); });
          }
  ...
  async GetData() {
    ...
    try {
      await this.collegeService.GetBterCollegeData(this.CollegeID)
        .then(async (data: any) => {         
