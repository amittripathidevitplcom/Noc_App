...
@Injectable()
  ...
  @Component({
    selector: 'app-bter-deficiency-marklist',
    templateUrl: './bter-deficiency-marklist.component.html',
    styleUrls: ['./bter-deficiency-marklist.component.css']
  })
export class BterDeficiencyMarklistComponent implements OnInit {
  ...
  public TotalDeficiencyMarkApplicationList: any = [];
  ...
  async GetDeficiencyMarkApplicationList() {
    debugger;
    try {
      this.loaderService.requestStarted();
      this.request.DepartmentID = this.sSOLoginDataModel.DepartmentID;
      await this.collegeservice.TotalBTERApplicationDetailsByDepartment(this.request, this.sSOLoginDataModel.SessionID, 'TotalDeficiencyMarkApplication')
        .then((data: any) => {
          debugger;
          data = JSON.parse(JSON.stringify(data));
          this.TotalDeficiencyMarkApplicationList = data['Data'][0]['data'];
  ...
  btnExportTable_Click(): void {
    this.loaderService.requestStarted();
    if (this.TotalDeficiencyMarkApplicationList.length > 0) {
      try {
