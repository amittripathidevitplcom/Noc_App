...
@Component({
  selector: 'app-update-bter-course-details-for-admin',
  templateUrl: './update-bter-course-details-for-admin.component.html',
  styleUrls: ['./update-bter-course-details-for-admin.component.css']
})

export class UpdateBterCourseDetailsForAdminComponent {
 ...
 // public ApplyAffiliation: string = '';
  ...
  public CollegeStatusName: string = '';
  public CollegeTypeID: number = 0;
  public CollegeTypeName: string = '';
  public CollegeLevelID: number = 0;
  public CollegeLevelName: string = '';
  public CollegeMedium: number = 0;
  public CollegeMediumName: string = '';
  public ManagementTypeID: number = 0;
  public AffiliationManagementTypeName: string = '';
  public StatusOfBuildingID: number = 0;
  public BTERBuildingStatusName: string = '';
  public AffiliationTypeID: number = 0;
  public AffiliationTypeName: string = '';
  public SelectedDepartmentID: number = 0;
  ...
  async ngOnInit() {
    ...
    if (this.SelectedDepartmentID == 12) {
      await this.commonMasterService.GetBTERDetailsIDWise(this.CollegeID)
        .then((data: any) => {
          ...
          this.CollegeStatusID = data['Data'][0][0]['CollegeStatusID'];
          this.CollegeStatusName = data['Data'][0][0]['CollegeStatusName'];
          this.CollegeTypeID = data['Data'][0][0]['CollegeTypeID'];
          this.CollegeTypeName = data['Data'][0][0]['CollegeTypeName'];
          this.CollegeLevelID = data['Data'][0][0]['CollegeLevelID'];
          this.CollegeLevelName = data['Data'][0][0]['CollegeLevelName'];
          this.CollegeMedium = data['Data'][0][0]['CollegeMedium'];
          this.CollegeMediumName = data['Data'][0][0]['CollegeMediumName'];
          this.ManagementTypeID = data['Data'][0][0]['ManagementTypeID'];
          this.AffiliationManagementTypeName = data['Data'][0][0]['AffiliationManagementTypeName'];
          this.StatusOfBuildingID = data['Data'][0][0]['StatusOfBuildingID'];
          this.BTERBuildingStatusName = data['Data'][0][0]['BTERBuildingStatusName'];
          this.AffiliationTypeID = data['Data'][0][0]['AffiliationTypeID'];
          this.request.RegAffiliationStatusId = data['Data'][0][0]['AffiliationTypeID'];
          this.AffiliationTypeName = data['Data'][0][0]['AffiliationTypeName'];
          ...
          this.request.BTERRegID = data['Data'][0][0]['BTERRegID'];
          // this.AffiliationStatus = data['Data']['CollegeStatusName'];
          //this.Name = data['Data']['CollegeStatusName'];
          // this.DTEARNID = data['Data']['CollegeStatusName'];
          // this.ApplyAffiliation = data['Data']['CollegeStatusName'];
          //this.SearchRecordID = data['Data']['CollegeStatusName'];
          //this.SelectedDteAffiliationCollageID = data['Data']['CollegeStatusName'];
    ...
    //console.log(this.CollegeStatusName);
    ...
    try {
      ...
      await this.commonMasterService.GetCommonMasterList_DepartmentAndTypeWise(departmentId, "AffiliationCourseStatus")
        .then(async (data: any) => {
          ...
          if (this.CollegeStatusName == 'Existing' && this.AffiliationTypeStatus == 'Renewal Of Affiliation') {
          ...
          if (this.CollegeStatusName == 'Existing' && (this.AffiliationTypeStatus == 'Affiliation Under Court Case')) {
            const allowedActions = ['Closed', 'New'];
            this.StatusOfCollegeList = this.StatusOfCollegeList.filter((x: any) =>
              x?.Name && allowedActions.includes(x.Name)
            );
          }
          if (this.CollegeStatusName == 'Existing' && (this.AffiliationTypeStatus == 'Affiliation Only For EX Students')) {
    ...
    try {
      ...
      await this.commonMasterService.GetCommonMasterList_DepartmentAndTypeWise(departmentId, "AffiliationBranchType")
        .then(async (data: any) => {
          ...
          console.log(this.CollegeStatusName);
          console.log(this.AffiliationManagementTypeName);
          if (this.CollegeStatusName == 'Existing' && this.AffiliationManagementTypeName == 'Private') {
          ...
          if (this.CollegeStatusName == 'New' && this.AffiliationManagementTypeName == 'Private') {
            this.AffiliationBranchList = this.AffiliationBranchList.filter((element: any) => {
              return element.Name == "SFS";
            });
            this.request.BterBranchTypeId = this.AffiliationBranchList[0].ID;
          }
          //if (this.CollegeStatusName == 'New' && this.AffiliationManagementTypeName == 'Government') {
          ...
          //}
          //if (this.CollegeStatusName == 'Existing' && this.AffiliationManagementTypeName == 'Government') {
          //  const allowedActions = ['SFS', 'GAS'];
          //  this.AffiliationBranchList = this.AffiliationBranchList.filter((x: { ActionName: string }) =>
          //    allowedActions.includes(x.ActionName)
          //  );
  ...
  async SaveData() {
    ...
    if (this.SelectedDepartmentID == 12) {
      ...
      if (this.CollegeStatusName == 'Existing') {
      ...
      if (this.CollegeStatusName == 'Existing' && this.SelectedYear != this.currentFinancial && this.CourseStatus != 'New') {
      ...
      if (this.AffiliationManagementTypeName === 'Government' && this.CollegeStatusName == 'Existing' && this.SelectedYear != this.currentFinancial && this.CourseStatus != 'New') {
        if (this.branchname?.trim().toUpperCase() === 'SFS') {
          if (
    ...
    try {
      ...
      await this.dTEAffiliationAddCourseService.GetByID(BTERCourseID, this.sSOLoginDataModel.SSOID, this.UserID)
        .then(async (data: any) => {
          ...
          this.IsEdits = true;
          this.CollegeStatusName = data['Data'][0]['data']['Table'][0]["AffiliationCategory"];
