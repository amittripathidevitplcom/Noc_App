...
@Component({
  ...
  templateUrl: './bterapplication-fee-details.component.html',
  styleUrls: ['./bterapplication-fee-details.component.css']
})

export class BTERApplicationFeeDetailsComponent {  
  ...
  async RedirectPaymentRequest(pMERCHANTCODE: any, pENCDATA: any, pRequestURl: any) {
  ...
  async RedirectEgrassPaymentRequest(pMERCHANTCODE: any, pENCDATA: any, pServiceURL: any, pAUIN: any) {
