...
@Component({
  selector: 'app-updateotherdetailsadminforbter',
  templateUrl: './updateotherdetailsadminforbter.component.html',
  styleUrls: ['./updateotherdetailsadminforbter.component.css']
})

export class UpdateotherdetailsadminforbterComponent {
  ...
  public AffiliationRegStatus: string = '';
        ...
        await this.dTEAffiliationOtherDetailsService.SaveData(this.request)
          .then((data: any) => {
            ...
            if (!this.State) {
              ...
              this.routers.navigate(['/totalApplicationAffiliation/ALL']);
