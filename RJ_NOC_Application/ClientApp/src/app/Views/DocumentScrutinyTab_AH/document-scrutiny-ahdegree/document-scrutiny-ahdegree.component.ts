...
@Component({
  selector: 'app-document-scrutiny-ahdegree',
  templateUrl: './document-scrutiny-ahdegree.component.html',
  styleUrls: ['./document-scrutiny-ahdegree.component.css']
})
export class DocumentScrutinyAHDegreeComponent implements OnInit {
