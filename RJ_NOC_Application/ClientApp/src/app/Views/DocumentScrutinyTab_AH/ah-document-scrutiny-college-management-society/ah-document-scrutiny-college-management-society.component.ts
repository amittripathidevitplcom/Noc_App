...
@Component({
  ...
  styleUrls: ['./ah-document-scrutiny-college-management-society.component.css']
})
export class AhDocumentScrutinyCollegeManagementSocietyComponent implements OnInit {
