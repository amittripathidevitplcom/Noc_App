...
@Component({
  ...
  templateUrl: './ah-document-scrutiny-old-nocdetails.component.html',
  styleUrls: ['./ah-document-scrutiny-old-nocdetails.component.css']
})
export class AhDocumentScrutinyOldNocdetailsComponent implements OnInit {
