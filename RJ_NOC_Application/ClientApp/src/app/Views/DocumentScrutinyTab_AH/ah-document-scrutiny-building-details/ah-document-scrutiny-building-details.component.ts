...
@Component({
  ...
  styleUrls: ['./ah-document-scrutiny-building-details.component.css']
})
export class AhDocumentScrutinyBuildingDetailsComponent implements OnInit {
