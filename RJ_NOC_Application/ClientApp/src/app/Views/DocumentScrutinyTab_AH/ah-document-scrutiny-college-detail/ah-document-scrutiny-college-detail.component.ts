...
@Component({
  selector: 'app-ah-document-scrutiny-college-detail',
  templateUrl: './ah-document-scrutiny-college-detail.component.html',
  styleUrls: ['./ah-document-scrutiny-college-detail.component.css']
})
export class AhDocumentScrutinyCollegeDetailComponent implements OnInit {
