...
@Component({
  selector: 'app-agri-piforward-to-commitee-list',
  templateUrl: './agri-piforward-to-commitee-list.component.html',
  styleUrls: ['./agri-piforward-to-commitee-list.component.css']
})
export class AgriPIForwardToCommiteeListComponent {
