...
@Component({
  selector: 'app-agri-document-scrutiny-legal-entity',
  templateUrl: './agri-document-scrutiny-legal-entity.component.html',
  styleUrls: ['./agri-document-scrutiny-legal-entity.component.css']
})
export class AgriDocumentScrutinyLegalEntityComponent implements OnInit {
