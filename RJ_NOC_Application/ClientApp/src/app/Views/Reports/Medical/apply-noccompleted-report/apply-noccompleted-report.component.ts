...
@Component({
  selector: 'app-apply-noccompleted-report',
  templateUrl: './apply-noccompleted-report.component.html',
  styleUrls: ['./apply-noccompleted-report.component.css']
})
export class ApplyNOCCompletedReportComponent implements OnInit {
  ...
  public ApplyNOCCompleteList: any = [];
      ...
      await this.applyNOCApplicationService.GetApplyNOCCompletedReport(UserID, 'Release NOC')
        .then((data: any) => {
          ...
          if (data['Data'][0]['data'].length > 0) {
            this.ApplyNOCCompleteList = data['Data'][0]['data'];
          }
