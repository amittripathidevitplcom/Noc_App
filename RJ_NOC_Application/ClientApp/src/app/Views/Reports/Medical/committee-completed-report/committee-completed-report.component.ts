...
@Component({
  selector: 'app-committee-completed-report',
  templateUrl: './committee-completed-report.component.html',
  styleUrls: ['./committee-completed-report.component.css']
})
export class CommitteeCompletedReportComponent implements OnInit {
