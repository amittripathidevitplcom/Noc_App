...
@Component({
  selector: 'app-secretary-completed-report',
  templateUrl: './secretary-completed-report.component.html',
  styleUrls: ['./secretary-completed-report.component.css']
})
export class SecretaryCompletedReportComponent implements OnInit {
  ...
  async GetApplicationCompletedReportUserWise(UserID: number, RoleID: number, DepartmentID: number) {
    try {
      ...
      await this.applyNOCApplicationService.GetApplyNOCCompletedReport(UserID, 'Forward To Committee', RoleID, DepartmentID)
        .then((data: any) => {
