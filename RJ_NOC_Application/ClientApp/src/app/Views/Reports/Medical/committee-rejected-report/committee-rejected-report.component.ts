...
@Component({
  selector: 'app-committee-rejected-report',
  templateUrl: './committee-rejected-report.component.html',
  styleUrls: ['./committee-rejected-report.component.css']
})
export class CommitteeRejectedReportComponent implements OnInit {
