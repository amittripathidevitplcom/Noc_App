...
export class DCENOCReportComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.DCENocReportForm = this.formBuilder.group(
      {
  ...
  get form() { return this.DCENocReportForm.controls; }
  ...
  async SaveData() {
    ...
    if (this.IsExisting == true) {
      this.DCENocReportForm.get('ddlYearofEstablishment')?.setValidators([DropdownValidators]);
      //this.CollegeDetailsForm.get('AISHECodeStatus')?.setValidators([DropdownValidators]);
      this.DCENocReportForm.get('ddlPresentCollegeStatus')?.setValidators([DropdownValidators]);
    }
    else {
      this.DCENocReportForm.get('ddlYearofEstablishment')?.clearValidators();
      //this.CollegeDetailsForm.get('AISHECodeStatus')?.clearValidators();
      this.DCENocReportForm.get('ddlPresentCollegeStatus')?.clearValidators();
    }
    this.DCENocReportForm.get('ddlYearofEstablishment')?.updateValueAndValidity();
    //this.CollegeDetailsForm.get('AISHECodeStatus')?.updateValueAndValidity();
    this.DCENocReportForm.get('ddlPresentCollegeStatus')?.updateValueAndValidity();

    console.log(this.request.RuralUrban);
    if (this.request.RuralUrban == 1) {
      this.DCENocReportForm.get('ddlPanchayatSamitiID')?.setValidators([DropdownValidators]);
      this.DCENocReportForm.get('ddlCityID')?.clearValidators();
    }
    else {
      this.DCENocReportForm.get('ddlPanchayatSamitiID')?.clearValidators();
      this.DCENocReportForm.get('ddlCityID')?.setValidators([DropdownValidators]);

    }
    this.DCENocReportForm.get('ddlPanchayatSamitiID')?.updateValueAndValidity();
    this.DCENocReportForm.get('ddlCityID')?.updateValueAndValidity();


    if (this.request.DepartmentID == 3) {
      this.DCENocReportForm.get('AISHECodeStatus')?.setValidators([Validators.required]);
    }
    else {
      this.DCENocReportForm.get('AISHECodeStatus')?.clearValidators();
    }
    this.DCENocReportForm.get('AISHECodeStatus')?.updateValueAndValidity();

    if (this.request.DepartmentID == 5) {
      this.DCENocReportForm.get('ddlTypeofCollege')?.setValidators([Validators.required]);
      this.DCENocReportForm.get('CollegeNAACAccredited')?.clearValidators();
    }
    else {
      this.DCENocReportForm.get('ddlTypeofCollege')?.clearValidators();
      this.DCENocReportForm.get('CollegeNAACAccredited')?.setValidators([Validators.required]);
    }
    this.DCENocReportForm.get('ddlTypeofCollege')?.updateValueAndValidity();
    this.DCENocReportForm.get('CollegeNAACAccredited')?.updateValueAndValidity();
    ...
    console.log(this.DCENocReportForm);
    let isValid = true;
    ...
    if (this.DCENocReportForm.invalid) {
      isValid = false;
    }
