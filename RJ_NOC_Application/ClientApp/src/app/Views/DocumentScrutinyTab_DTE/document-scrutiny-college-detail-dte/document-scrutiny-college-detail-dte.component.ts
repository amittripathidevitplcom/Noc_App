...
@Component({
  selector: 'app-document-scrutiny-college-detail-dte',
  templateUrl: './document-scrutiny-college-detail-dte.component.html',
  styleUrls: ['./document-scrutiny-college-detail-dte.component.css']
})
export class DocumentScrutinyCollegeDetailDTEComponent implements OnInit {
  constructor(private dtedocumentscrutiny: DocumentScrutinyDTEComponent, private dteDocumentScrutinyService: DTEDocumentScrutinyService, private applyNOCApplicationService: ApplyNOCApplicationService, private draftApplicationListService: DraftApplicationListService, private toastr: ToastrService, private loaderService: LoaderService, private formBuilder: FormBuilder, private commonMasterService: CommonMasterService, private router: ActivatedRoute, private routers: Router, private collegeService: CollegeService, private sSOLoginService: SSOLoginService) {
