...
@Component({
  selector: 'app-document-scrutiny-hostal-details-component-dte',
  templateUrl: './document-scrutiny-hostal-details-component-dte.component.html',
  styleUrls: ['./document-scrutiny-hostal-details-component-dte.component.css']
})
export class DocumentScrutinyHostalDetailsComponentDTEComponent implements OnInit {
