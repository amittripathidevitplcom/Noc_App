...
@Component({
  selector: 'app-document-scrutiny-academic-information-dte',
  templateUrl: './document-scrutiny-academic-information-dte.component.html',
  styleUrls: ['./document-scrutiny-academic-information-dte.component.css']
})
export class DocumentScrutinyAcademicInformationDTEComponent implements OnInit {
  ...
  constructor(private dceDocumentScrutinyService: DTEDocumentScrutinyService, private academicInformationDetailsService: AcademicInformationDetailsService, private loaderService: LoaderService, private formBuilder: FormBuilder,
