...
export class DocumentScrutinyRoomDetailsDTEComponent implements OnInit {
  ...
  async GetRoomDetailAllList() {
    try {
      ...
      await this.dtedocumentScrutinyService.DocumentScrutiny_RoomDetail(this.SelectedCollageID, this.sSOLoginDataModel.RoleID, this.SelectedApplyNOCID, this.QueryStringApplicationStatus)
        .then((data: any) => {
