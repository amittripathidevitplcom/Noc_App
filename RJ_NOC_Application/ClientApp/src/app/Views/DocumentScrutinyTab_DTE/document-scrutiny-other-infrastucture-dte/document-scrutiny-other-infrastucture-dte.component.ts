...
@Component({
  selector: 'app-document-scrutiny-other-infrastucture-dte',
  templateUrl: './document-scrutiny-other-infrastucture-dte.component.html',
  styleUrls: ['./document-scrutiny-other-infrastucture-dte.component.css']
})
export class DocumentScrutinyOtherInfrastuctureDTEComponent implements OnInit {
  ...
  constructor(private dcedocumentscrutiny: DocumentScrutinyDTEComponent, private otherInformationService: OtherInformationService, private commonMasterService: CommonMasterService, private formBuilder: FormBuilder, private dcedocumentScrutinyService: DTEDocumentScrutinyService,
