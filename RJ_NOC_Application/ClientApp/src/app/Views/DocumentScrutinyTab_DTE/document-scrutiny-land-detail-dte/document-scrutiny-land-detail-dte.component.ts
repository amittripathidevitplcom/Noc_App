...
@Component({
  selector: 'app-document-scrutiny-land-detail-dte',
  templateUrl: './document-scrutiny-land-detail-dte.component.html',
  styleUrls: ['./document-scrutiny-land-detail-dte.component.css']
})
export class DocumentScrutinyLandDetailDTEComponent implements OnInit {
