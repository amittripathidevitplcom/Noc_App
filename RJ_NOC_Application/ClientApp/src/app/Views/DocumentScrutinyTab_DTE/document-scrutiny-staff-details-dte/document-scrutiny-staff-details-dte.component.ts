...
@Component({
  selector: 'app-document-scrutiny-staff-details-dte',
  templateUrl: './document-scrutiny-staff-details-dte.component.html',
  styleUrls: ['./document-scrutiny-staff-details-dte.component.css']
})
export class DocumentScrutinyStaffDetailsDTEComponent implements OnInit {
  ...
  constructor(private dcedocumentscrutiny: DocumentScrutinyDTEComponent, private buildingDetailsMasterService: BuildingDetailsMasterService, private commonMasterService: CommonMasterService, private staffDetailService: StaffDetailService, private dcedocumentScrutinyService: DTEDocumentScrutinyService,
