...
import { BasicDetailsDataModel } from '../../../Models/DTEStatistics/BasicDetailsDataModel';
@Injectable({
  providedIn: 'root'
})
export class BasicDetailsService {
  readonly APIUrl = GlobalConstants.apiURL + "DTEStatistics_BasicDetails";
  ...
  public async SaveData(request: BasicDetailsDataModel) {
