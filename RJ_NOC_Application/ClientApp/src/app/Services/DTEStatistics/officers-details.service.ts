...
export class OfficersDetailsService {

  readonly APIUrl = GlobalConstants.apiURL + "DTEStatistics_OfficersDetails";
  ...
  public async SaveData(request: OfficersDetailsDataModel) {
