...
import { PlacementDetailsDataModel } from '../../../Models/DTEStatistics/PlacementDetailsDataModel';
...
export class PlacementDetailsService {
  ...
  readonly APIUrl = GlobalConstants.apiURL + "DTEStatistics_PlacementDetails";
  ...
  public async SaveData(request: PlacementDetailsDataModel) {
