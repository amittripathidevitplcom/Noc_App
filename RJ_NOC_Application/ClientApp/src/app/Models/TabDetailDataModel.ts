...
export class BuildingDetailsDataModel {
  ...
  public ResidentialBuildingTypeID: number = null;
  public MGOneResidentialIstheCampusUnitary: string = '';
  public ResidentialOwnerName: string = '';
  public ResidentialAddressLine1: string = '';
  public ResidentialAddressLine2: string = '';
  public ResidentialRuralUrban: string = '';
  public ResidentialDistance: number =0;
  public ResidentialDivisionID: number =0;
  public ResidentialDistrictID: number =0;
  public ResidentialTehsilID: number =0;
  public ResidentialCityID: number =0;
  public ResidentialPanchayatSamitiID: number = 0;
  public ResidentialCityTownVillage: string = '';
  public ResidentialContactNo: string = '';
  public ResidentialPincode: string = '';
  public ResidentialBuildingHostelQuartersRoadArea: number =0;
  public ResidentialRentvaliditydate: string = '';  
  public ResidentialbuildingOtherDoc1FileUpload: string = '';
  public ResidentialDis_buildingOtherDoc1FileUpload: string = '';
  public ResidentialbuildingOtherDoc1FileUploadPath: string = '';
  public ResidentialbuildingOtherDoc2FileUpload: string = '';
  public ResidentialDis_buildingOtherDoc2FileUpload: string = '';
  public ResidentialbuildingOtherDoc2FileUploadPath: string = '';
  public ResidentialRentAgreementFileUpload: string = '';
  public ResidentialDis_RentAgreementFileUpload: string = '';
  public ResidentialRentAgreementFileUploadPath: string = '';
  public AuthoritybuildingOtherDoc1FileUpload: string = '';
  public AuthorityDis_buildingOtherDoc1FileUpload: string = '';
  public AuthoritybuildingOtherDoc1FileUploadPath: string = '';
  public MGOneDrainage: string = '';  
  public BuildingUseNameoftheAuthority: string = '';
  public BuildingUseOrderNo: string = '';
  public BuildingUseDateApproval: string = '';
  public buildingUseOtherDoc1FileUpload: string = '';
  public Dis_buildingUseOtherDoc1FileUpload: string = '';
  public buildingUseOtherDoc1FileUploadPath: string = '';
  public PollutionDateApproval: string = '';
  public ValidDateApproval: string = '';
  public PollutionbuildingOtherDoc1FileUpload: string = '';
  public PollutionDis_buildingOtherDoc1FileUpload: string = '';
  public PollutionbuildingOtherDoc1FileUploadPath: string = '';
  public ResidentialBuildingName: string = '';
