export class GlobalConstants {
 ...
 // public static apiURL: string = "http://172.22.33.75:1006/api/";
...
//
//    return CryptoJS.AES.encrypt(planTest.trim(), "RJNoc465717444").toString();
//  }
//  public Decrypt(encryptText: string) {
//    return CryptoJS.AES.decrypt(encryptText.trim(), "RJNoc465717444").toString(CryptoJS.enc.Utf8);
//  }
//} 
